document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (event) {
      ...
      welcomeMessage.textContent = `Welcome ${usernameInput.value}! The country code you selected is ${countrySelect.value}`;
    ...
    function validateForm() {
      ...
      const isPasswordValid = passwordInput.value.length >= 9;
      ...
      submitButton.disabled = !(isUsernameValid && isPasswordValid && isConfirmPasswordValid && isCheckboxChecked && isCountrySelected);
    }
  });
